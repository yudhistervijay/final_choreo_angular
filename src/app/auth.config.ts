...
export const authCodeFlowConfig: AuthConfig = {
    ...
    responseType: 'code',
    redirectUri: 'https://83cf81d6-14e2-46e9-92bd-d4b559e3a595.e1-us-cdp-2.choreoapps.dev/dashboard',
   //redirectUri:'http://localhost:4200/dashboard',
    ...
    postLogoutRedirectUri: 'https://83cf81d6-14e2-46e9-92bd-d4b559e3a595.e1-us-cdp-2.choreoapps.dev/dashboard',
